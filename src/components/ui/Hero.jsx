  ...
  return (
    <section className="hero flex flex-col">
      <h1 className=" text-center sm:text-left">
        Raul Davila Desarrollador Web{" "}
        <span className="hidden sm:inline">Front End</span>
        <span className="accent blink font-extrabold">|</span>
      </h1>
      <article className="mt-8  flex flex-col sm:flex-row  gap-4">
        <div>
          <Image
            src="/images/bwheroimg.webp"
            alt="heroimage"
            width={150}
            height={150}
            priority={true}
          ...
          <p>
            Si te interesa lo que hago{" "}
            <span className="accent">contáctame</span> a través de mis redes
            sociales o enviarme un correo electrónico.
          </p>
        </div>
      </article>
      <SocialLinks />
